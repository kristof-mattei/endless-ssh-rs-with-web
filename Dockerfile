...
FROM --platform=${BUILDPLATFORM} rust:1.97.1-slim-trixie@sha256:2b5ac005280f9747359b11800f895340b707f701b9b789bfcdb55a269fd2feef AS rust-base
...
# front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:26.6.0-alpine3.24@sha256:a4fb14143ee24c038c851864fe85fd90f9121abc8fdca3092798bcc02e06b1d8 AS typescript-build
